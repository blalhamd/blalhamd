<h1 align="center">Hi, I'm Bilal Sayed Mohamed 👋</h1>
...
📂 **[TaskFlow](https://github.com/blalhamd/TaskFlow.git)** A comprehensive task management system designed to streamline workflow efficiency using advanced backend patterns.  
✨ *Technologies:* .NET 8.0, Clean Architecture, CQRS, SQL Server.

📂 **[Customer-Account-Management-System](https://github.com/blalhamd/Customer-Account-Management-System.git)** A secure banking-style system for managing customer accounts, transactions, and profile data with robust validation.  
✨ *Technologies:* .NET Core, Web API, SQL Server, Entity Framework Core.

📂 **[Online Exam api](https://github.com/blalhamd/Online-Exam-api.git)** A RESTful API designed to handle online examinations, question banks, and automated student grading.  
✨ *Technologies:* .NET Core Web API, Repository Pattern, SQL Server.

📂 **[HR_System](https://github.com/blalhamd/HR_System.git)** A human resources management solution handling employee data, attendance, and payroll.  
✨ *Technologies:* .NET Core, Docker, SQL Server, Angular.

📂 **[Talabat System](https://github.com/blalhamd/Talabat.git)** Online ordering platform integrating Stripe payments, Redis caching, and efficient data handling.  
✨ *Technologies:* .NET Core 8.0, SQL Server, Redis, Angular 17.

📂 **[Survey Basket](https://github.com/blalhamd/SurveyBasket.git)** A dynamic survey platform for creating and analyzing polls with a multi-layered architecture.  
